...
class MockWebClient(WebClient):
    ...
    class RuleBuilderStep1:
        ...
        def has_method(
            self, matcher: Optional[Matcher[WebMethod]]
        ) -> "MockWebClient.RuleBuilderStep2":
            return MockWebClient.RuleBuilderStep2(self._mock_client, matcher)
    ...
    class RuleBuilderStep2:
        ...
        def has_url(
            self, matcher: Optional[StringMatcher]
        ) -> "MockWebClient.RuleBuilderStep3":
            return MockWebClient.RuleBuilderStep3(
                self._mock_client, self._method_matcher, matcher
            )
    ...
    class RuleBuilderStep3:
        ...
        def has_parameter(
            self, matcher: DictMatcher[str, str]
        ) -> "MockWebClient.RuleBuilderStep3":
            self._parameter_matchers.append(matcher)
            return self

        def has_authentication(
            self, matcher: Optional[TupleMatcher[str, str]]
        ) -> "MockWebClient.RuleBuilderStep3":
        ...
        def has_header(
            self, matcher: DictMatcher[str, List[str]]
        ) -> "MockWebClient.RuleBuilderStep3":
            self._header_matchers.append(matcher)
            return self

        def has_verify(
            self, matcher: Matcher[Union[bool, Path]]
        ) -> "MockWebClient.RuleBuilderStep3":
