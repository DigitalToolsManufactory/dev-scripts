...
class TestMockShell(TestCase):
    def test_run_any_command_without_arguments(self) -> None:
        ...
        mock.when_command(StringMatcher.any()).then_return(
            MockShellResponse.of_success("Succeeded!")
        )
    ...
    def test_run_command_without_arguments(self) -> None:
        ...
        mock.when_command(StringMatcher.exact("echo")).then_return(
            MockShellResponse.of_success("Succeeded!")
        )
    ...
    def test_run_any_command_with_arguments(self) -> None:
        ...
        mock.when_command(StringMatcher.any()).has_argument(
            StringMatcher.contains_exact("Hello, World!")
    ...
    def test_run_command_with_arguments(self) -> None:
        ...
        mock.when_command(StringMatcher.exact("echo")).has_argument(
            StringMatcher.contains_exact("Hello, World!")
        ).then_return(MockShellResponse.of_success("Succeeded!"))
    ...
    def test_run_rules_match_in_order(self) -> None:
        ...
        first_mock.when_command(StringMatcher.any()).then_return(
            MockShellResponse.of_success("Generic!")
        )
        first_mock.when_command(StringMatcher.exact("echo")).has_argument(
            StringMatcher.contains_exact("Hello, World!")
        ...
        second_mock.when_command(StringMatcher.exact("echo")).has_argument(
            StringMatcher.contains_exact("Hello, World!")
        ).then_return(MockShellResponse.of_success("Specific!"))
        second_mock.when_command(StringMatcher.any()).then_return(
            MockShellResponse.of_success("Generic!")
        )
